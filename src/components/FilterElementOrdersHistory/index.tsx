import { selectMarkets, THistoryBalanceType } from 'modules';
import * as moment from 'moment-timezone';
import React, { useState } from 'react';
import { useSelector } from 'react-redux';
import { IQueryForFunding } from 'screens';
...
export const FilterElement: React.FC<Props> = props => {
	...
	const renderSelection = () => {
		return (
			<React.Fragment>
				<div className="filter-select__coin">coin</div>
				<select
	...
	return (
		<div className="history-screen__filter">
			<form className="d-flex flex-wrap align-items-center">
				...
				<div className="history-screen__filter__select history-screen__filter__select--type d-flex align-items-center">
...
interface IFilterElementForQueryP2pHistory {
	queryForFunding: IQueryForFunding;
	setQueryForFunding: (queryForFunding: IQueryForFunding) => void;
	setPage: (page: number) => void;
}
export const FilterElementForQueryP2pHistory: React.FC<IFilterElementForQueryP2pHistory> = props => {
	const { queryForFunding, setQueryForFunding, setPage } = props;
	...
	return (
		<div className="history-screen__filter">
			<form className="d-flex flex-wrap align-items-center">
				<div className="history-screen__filter__date d-flex align-items-center">
					<div className="history-screen__filter__date__desc">Date</div>
					{renderInputDate('startedAt')}
					{renderInputDate('endedAt')}
				</div>
				...
				<div className="history-screen__filter__select history-screen__filter__select--type d-flex align-items-center">
					...
					<div className="history-screen__filter__select__choose">
						<select
							...
							className="select-form-control"
							name="side"
							value={queryForFunding.type}
							onChange={e => {
								setQueryForFunding({
									...queryForFunding,
									type: e.target.value === 'all' ? undefined : (e.target.value as THistoryBalanceType),
								});
							}}
						>
							<option value="all">All</option>
