...
import {
	...
	NewWalletDetail,
	NewWalletFundingDetail,
	NewWalletFundingHistoryMobileScreen,
	...
	public render() {
			...
			return (
				<div className={'container-fluid pg-layout pg-layout--mobile'}>
					<Switch>
						...
						<PublicRoute path="/markets" component={ReferralMobileScreen} />
						...
						{/* new feature */}
						<PublicRoute path="/p2p" component={P2pLayout} />
						<PublicRoute path="/express" component={ExpressMobileScreen} />
						...
						<PrivateRoute
							loading={userLoading}
							isLogged={isLoggedIn}
							path="/funding-wallets/history"
							component={NewWalletFundingHistoryMobileScreen}
						/>
						<PrivateRoute
							loading={userLoading}
							isLogged={isLoggedIn}
						...
						<PrivateRoute
							loading={userLoading}
							isLogged={isLoggedIn}
							path="/funding-wallets/:currency/detail"
							component={NewWalletFundingDetail}
						/>
						<PrivateRoute
							loading={userLoading}
							isLogged={isLoggedIn}
		...
		return (
			<div className={`container-fluid pg-layout ${tradingCls}`}>
				<Switch>
					<PublicRoute exact={true} path="/announcements" component={Referral} />
					<PublicRoute exact={true} path="/announcements/detail/:id" component={AnnouncementDetail} />
					<PublicRoute exact={true} path="/" component={HomepageScreen} />
					...
					<PublicRoute path="/express" component={Express} />
