...
const ReferralDesktopBanner = require('./Assets/referral-desktop-banner.jpg');
			...
			return (
				<div className="col-lg-4 col-md-12 td-pg-referral__rank__box mb-3">
					<div className="td-pg-referral__rank__box__row">
						...
						<div className="col-5">
							<div>
								<span className="text-dark td-pg-referral__rank__box__row__commision__coin-name">{`NO.${rankIndex}`}</span>
							</div>
							<div className="mt-3">
								<span data-tip={email} className="text-dark td-pg-referral__rank__box__row__rank__mail">
									{email}
								</span>
							</div>
						</div>
						<div className="col-5">
							...
							<div className="text-right mt-3">
								<span data-tip={commission} className="text-dark td-pg-referral__rank__box__row__rank__commision">
									{commission}
								</span>
							</div>
						</div>
						...
						>
							<div className="referral-loggedIn-userLogIn__wrapper">
								...
								<div className="referral-loggedIn-userLogIn__wrapper__login">
									...
									<p>
										{' '}
										Not on Octium yet?<span onClick={redirectToRegister}>Register</span>
									</p>
								</div>
							</div>
						</div>
	...
	const renderProgramDetail = () => {
		return (
			<div className="td-pg-referral__detail">
				<div className="container-fluid">
					<h2 className="text-dark">Program Details</h2>
					<div className="row mt-5">
						<div className="col-md-6 d-flex justify-content-start align-items-start">
							<img src={Stick} alt="stick" />
							<p className="mb-0 text-dark mb-5 ml-4">Effective as of 2021/08/11 0:00 AM (UTC)</p>
						</div>
						<div className="col-md-6 d-flex justify-content-start align-items-start">
							<img src={Stick} alt="stick" />
							<p className="mb-0 text-dark mb-5 ml-4">
						...
						<div className="col-md-6 d-flex justify-content-start align-items-start">
							<img src={Stick} alt="stick" />
							<p className="mb-0 text-dark mb-5 ml-4">
								The fee commission will be sent instantly in real-time to your Octium account as your referee
						...
						<div className="col-md-6 d-flex justify-content-start align-items-start">
							<img src={Stick} alt="stick" />
							<p className="mb-0 text-dark mb-5 ml-4">
								Octium will check for duplicate or fake accounts and will not pay out referral bonuses on these
					...
					<div className="td-pg-referral__detail__container__notice">
						<div className="row">
							...
							<div className="col-11">
								<p className="text-dark">Important Notice:</p>
								<p className="text-dark">
									Octium reserves the right to change the terms of the referral program at any time due to
