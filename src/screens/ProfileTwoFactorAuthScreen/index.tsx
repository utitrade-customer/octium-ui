...
class ToggleTwoFactorAuthComponent extends React.Component<Props, State> {
			...
			<div className="container mt-5 mb-5 pg-profile-two-factor-auth__form p-0">
				...
				<div className="row m-0 pg-profile-two-factor-auth__body">
					...
					<div className="col-12 col-lg-4 col-md-3 pt-4 pg-profile-two-factor-auth__body--barcode">
						{!this.props.otp && this.renderTwoFactorAuthQR(barcode)}
					</div>
				</div>
				<div className="row m-0 p-5 pg-profile-two-factor-auth__copyablefield">
					{!this.props.otp && secret && this.renderSecret(secret)}
				</div>
				<div className="row m-0 pg-profile-two-factor-auth__body">
	...
	private renderSecret = (secret: string) => {
		const RenderCopySecret = () => {
			return (
				<div className="pg-profile-two-factor-auth__copyablefield__container__box-copy">
					<div className="pg-profile-two-factor-auth__copyablefield__container__box-copy__text">
						<input type="text" id="copyablefield2fa" value={secret} />
					</div>

					<div className="pg-profile-two-factor-auth__copyablefield__container__box-copy__btn">
		...
		return (
			<div className="pg-profile-two-factor-auth__copyablefield__container">
				...
				<fieldset onClick={this.doCopy}>{secret && <RenderCopySecret />}</fieldset>
			</div>
		);
	};
