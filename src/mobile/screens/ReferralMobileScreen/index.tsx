			...
			return (
				<div className="col-lg-4 col-md-12 td-mobile-pg-referral__rank__box mb-3">
					<div className="td-mobile-pg-referral__rank__box__row">
						...
						<div className="col-5">
							<div>
								<span className="text-dark td-mobile-pg-referral__rank__box__row__commision__coin-name">{`NO.${rankIndex}`}</span>
							</div>
							<div className="mt-3">
								<span data-tip={email} className="text-dark td-mobile-pg-referral__rank__box__row__rank__mail">
									{email}
								</span>
							</div>
						</div>
						<div className="col-5">
							...
							<div className="text-right mt-3">
								<span
									data-tip={commission}
									className="text-dark td-mobile-pg-referral__rank__box__row__rank__commision"
								>
									{commission}
								</span>
							</div>
				...
				<div className="container">
					...
					<div className="row mt-3">
						<div className="col-md-6 d-flex justify-content-start align-items-start">
							...
							<p className="mb-0 text-dark mb-3 ml-4">Effective as of 2021/09/10 0:00 AM (UTC)</p>
						</div>
						<div className="col-md-6 d-flex justify-content-start align-items-start">
							<img src={Stick} alt="stick" />
							<p className="mb-0 text-dark mb-3 ml-4">
