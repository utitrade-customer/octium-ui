						...
						<div className="col-12">
							<div className="referral-container-content">
								...
								>
									...
									<p className="text-dark" style={{ marginLeft: '20px' }}>
										{referralID}
									</p>
								</div>
								<div
								...
								<div className="row mt-3 td-mobile-referral-content__table__row__col-left__friends px-1">
									{friends[1].map((friend, index) => (
										<React.Fragment key={index}>
											<div className="col-6 text-dark td-mobile-referral-content__table__row__col-left__friends-email text-left">
												<span data-tip={friend.email}>{friend.email}</span>
												<ReactTooltip />
											</div>
											<div className="col-6 text-right text-dark td-mobile-referral-content__table__row__col-left__friends-time">
							...
							<div className="col-12 td-mobile-referral-content__table__row__col-right">
								...
								<div className="row mt-3 td-mobile-referral-content__table__row__col-right__commision px-1">
									{commisionHistories[1].map((history, index) => (
										<React.Fragment key={index}>
											<div className="col-4 text-left text-dark">{history.total}</div>
											<div className="col-4 text-left text-dark td-mobile-referral-content__table__row__col-right__commision-email">
