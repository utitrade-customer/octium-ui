		...
		return listHistory.payload.map((item, index) => {
			return (
				<React.Fragment key={index}>
					<tr className="text-center" style={{ color: 'var(--system-text-black-color)', border: '1px solid #848e9' }}>
						<td>{item.uid}</td>
						<td>
	...
	return (
		<>
			<div id="buyers-ieo-mobile-history">
				<h2 className="p-3 text-dark">{intl.formatMessage({ id: 'page.ieo.detail.buyerHistory.allPurchases.title' })}</h2>
