...
export const P2pPostOderStep1: FC<P2pPostOrderStep1Props> = ({
	...
	return (
		<Form
			...
			form={form}
		>
			<div className="p2p-post-order-mobile-screen-step-wrapper p2p-post-order-mobile-screen__step-1">
				<Tabs
				...
				<div className="p2p-tab-content">
					<div className="p2p-post-order-mobile-screen__step-1__radio-group">
						<h4 className="p2p-post-order-mobile-screen__step-1__radio-group__title">Asset</h4>
						<div>
					...
					<div className="p2p-post-order-mobile-screen__step-1__radio-group">
						<h4 className="p2p-post-order-mobile-screen__step-1__radio-group__title">with Cash</h4>
						{fiat}
						<div>
							{infoSupportedLoading ? (
								'...'
					...
					<div className="p2p-post-order-mobile-screen__step-1__init">
						<div className="p2p-post-order-mobile-screen__step-1__init__price-info">
							<div className="p2p-post-order-mobile-screen__step-1__init__price-info__price">
								<div className="mb-1">Your Price</div>
								<span className="d-flex flex-row">
									{formatNumberP2p(price || 0, fiatTmp?.decimal)}
									<div className="p2p-post-order-mobile-screen__step-1__init__price-info__price__currency ml-2">
										{getSymbol()}
									</div>
								</span>
							</div>
						...
						<div className="p2p-post-order-mobile-screen__step-1__init__price-type">
							<h4>Price type</h4>
						...
						<Form.Item
							...
							rules={[
								{
									validator: () => {
										return !!price ? Promise.resolve() : Promise.reject(new Error(`You must input price`));
									},
								},
							]}
						>
							<div className="p2p-post-order-mobile-screen__step-1__init__price-value">
								<h4>{priceType === 'Fixed' ? 'Fixed' : 'Floating Price Margin'}</h4>
								<div className="p2p-post-order-mobile-screen__step-1__init__price-value__box">
									...
									<div style={{ position: 'relative' }}>
										...
										{priceType === 'Floating' && (
											<span className="p2p-post-order-mobile-screen__step-1__init__price-value__box__percentage">
												{' '}
												%{' '}
											</span>
										)}
			...
			<div className="p2p-post-order-mobile-screen__step-1__navigate">
