...
export const P2pAddPaymentMobileScreen = () => {
	...
	const classNameBtnDone = classNames('pg-mobile-p2p-add-payment__box__group-btn__box__btn pg-p2p-config-global__btn', {
	...
	const uploadButton = (
		<div className="pg-mobile-p2p-add-payment__box__field__upload-img">
			<PlusOutlined />
			<div>Upload</div>
		</div>
	);
	...
	return (
		<div className="pg-mobile-p2p-add-payment">
			...
			<div className="container">
				...
				>
					{(listPaymentMethods.isLoading || isChangeLoading) && <Loading />}

					{methodConfig && (
						<>
							<div className="pg-mobile-p2p-add-payment__box">
								<div className="pg-mobile-p2p-add-payment__box__name-method">{methodConfig.name}</div>
								...
								{methodConfig.fields.map((item, key) => {
									...
									switch (type) {
										...
										case 'number':
											return (
												<div className="pg-mobile-p2p-add-payment__box__field" key={key}>
													<Form.Item
								...
								<div className="pg-mobile-p2p-add-payment__box__tips">
									<div className="pg-mobile-p2p-add-payment__box__tips__title">Tips</div>
									<div className="pg-mobile-p2p-add-payment__box__tips__desc">
								...
								<div className="pg-mobile-p2p-add-payment__box__group-btn">
									<div className="pg-mobile-p2p-add-payment__box__group-btn__box">
										<button
											type="button"
											className="pg-mobile-p2p-add-payment__box__group-btn__box__btn pg-p2p-config-global__btn pg-p2p-config-global__btn--cancel"
