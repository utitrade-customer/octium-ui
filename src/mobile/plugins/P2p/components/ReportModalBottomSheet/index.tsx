...
import { alertPush, CreateP2PReportPayload } from 'modules';
import { LoadingGif } from 'components/LoadingGif';

const { Option } = Select;
const { TextArea } = Input;

interface ReportModalBottomSheetProps {
	title: string;
	show: boolean;
	onClose: () => void;
	onConfirmation: (payload: CreateP2PReportPayload) => void;
	isLoading: boolean;
}

export const ReportModalBottomSheet: FC<ReportModalBottomSheetProps> = ({ title, show, onClose, onConfirmation, isLoading }) => {
	...
	return (
		<MyP2pDrawer
			className="p2p-mobile-component-report-modal-bottom-sheet"
			onClose={() => {
				onClose();
			}}
			zIndex={2147483648}
			...
			height={'90vh'}
		>
			<div className="p2p-mobile-component-report-modal-bottom-sheet__notice">
				<RiErrorWarningFill
			...
			{isLoading && (
				<div className="p2p-mobile-component-report-modal-bottom-sheet__loading">
					<LoadingGif />
				</div>
			)}
			<div
				className="p2p-mobile-component-report-modal-bottom-sheet__content"
				style={{ height: '100%', display: 'inline-block', overflow: 'scroll' }}
			>
				<div className="mb-4 d-flex flex-column">
					<label className="p2p-mobile-component-report-modal-bottom-sheet__content__label">Report Reason</label>
					<Select
				...
				{/* <div className="mb-4 d-flex flex-column">
					<label className="p2p-mobile-component-report-modal-bottom-sheet__content__label">Your Email</label>
					<Input placeholder="Enter email address" size="large" />
				</div> */}
				{isInP2PUserCenter && (
					<div className="mb-4 d-flex flex-column">
						<label className="p2p-mobile-component-report-modal-bottom-sheet__content__label">Order Number</label>
						<Input
							value={tradeID}
				...
				<div className="mb-4 d-flex flex-column">
					<label className="p2p-mobile-component-report-modal-bottom-sheet__content__label">Description</label>
					<TextArea
						style={{ height: '7em' }}
						maxLength={500}
						value={description}
				...
				<div className="d-flex flex-column p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof">
					<label className="p2p-mobile-component-report-modal-bottom-sheet__content__label">Upload proof</label>

					<p className="p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof__suggestion">
					...
					<div className="p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof__images-container">
						{files.length > 0 &&
							files.map((item, index) => {
								return (
									<div
										key={index}
										className="p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof__images-container__image-container"
									>
										<img
											className="p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof__images-container__image-container__image"
											src={item}
											alt="image"
										/>
										<IoMdCloseCircle
											className="p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof__images-container__image-container__delete-image-icon"
						...
						<div
							className="p2p-mobile-component-report-modal-bottom-sheet__content__upload-proof__upload-btn"
			...
			<div className="p2p-mobile-component-report-modal-bottom-sheet__button-group mt-3">
				<Button
					className="p2p-mobile-component-report-modal-bottom-sheet__button-group__button p2p-mobile-component-report-modal-bottom-sheet__button-group__button__cancel"
					onClick={() => {
						onClose();
					}}
				>
				...
				<Button
					...
					className={`p2p-mobile-component-report-modal-bottom-sheet__button-group__button p2p-mobile-component-report-modal-bottom-sheet__button-group__button__confirm${
						isValid() ? '--active' : ''
					}`}
					onClick={() => {
						onConfirmation({
