...
import { catchErrorRankingCompetition, FetchRankingCompetition, getDataRankingCompetition, RankingCompetition } from '..';
...
export function* competitionRankingSaga(action: FetchRankingCompetition) {
	try {
		...
		const rankingCompetition: RankingCompetition[] = yield call(
