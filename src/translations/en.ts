...
export const en = {
	...
	'page.homePage.marketOverview.TopGainers': 'Top gainers',
	'page.homePage.marketOverview.TopLosers': 'Top Losers',
	'page.homePage.marketOverview.ValueLeaders': 'Value Leaders',
	'page.homePage.marketOverview.NewCoins': 'New Coins',
	...
	'page.homepage.marketOverview.table.header.Change': 'Change',
	'page.homePage.marketOverview.table.header.Value': 'Value',
	'page.homepage.marketOverview.table.header.volume': 'Volume',
	'page.homepage.marketOverview.table.header.Lowest': 'Lowest',
	'page.homepage.marketOverview.table.header.Highest': 'Highest',
	'page.homepage.marketOverview.table.header.Price': 'Price',
	...
	'page.profile.activeStep.title.welcome': 'Welcome to Octium',
	...
	'page.transaction.table.price': 'Octium Price',
	'page.transaction.table.total': 'Total (Octium)',
	...
	'page.ieo.detail.buyIeo.cautions.describe.text1': `Sale and purchase of {name} take place between you and {name} (the “Issuer”) and Octium is
	...
	// new /airdrop
	'page.airdrop.header.title': 'Octium Airdrop Hub',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
	...
	'page.footer.faq': 'FAQ',
	'page.footer.info.item.text1': 'Octium is a latest and fastest growing Crypto currency',
	'page.footer.info.item.text2': 'exchange which gives its users freedom and ease to earn',
	'page.footer.info.item.text3': 'profits through trading. Octium offers wide range of',
	'page.footer.info.item.text4': 'currencies for trade. Octium allows users to withdraw',
	'page.footer.info.item.text5': 'and deposit the currency anytime and anywhere.',
	'page.footer.info.link': 'support@octium.io',
	'page.footer.info.copyright.text1': 'Octium © 2021',
	'page.footer.info.copyright.text2': 'octium.io',
	'page.footer.info.copyright.text3': 'All rights reserved.',
	'page.footer.info.title.contact': 'CONTACT',
	'page.footer.info.title.quick.links': 'QUICK LINKS',
	'page.footer.info.title.item.markets': 'Markets',
	'page.footer.info.title.item.launchpad': 'Launchpad',
	'page.footer.info.title.item.competition': 'Competition',
	'page.footer.info.title.item.stake': 'Stake',
	'page.footer.info.title.item.promotion': 'Promotion',
	'page.footer.info.title.service.support': 'SERVICE SUPPORT',
	'page.footer.info.title.asset.fee': 'Asset Fee',
	'page.footer.info.title.announcements': 'Announcements',
	'page.footer.info.title.list.token.coin': '	List Token/Coin',
	'page.footer.info.title.API.documentation': 'API Documentation',
	...
	'page.header.signUp.welcome': 'Welcome to Octium',
	...
	'success.p2p.payment.create': 'Create payment success',
	'success.p2p.payment.edit': 'Edit payment success',
	'success.p2p.payment.delete': 'Delete payment success',
	'success.p2p.order.create': 'Create orders p2p success',
	'success.p2p.order.update': 'Update orders p2p success',
	'success.p2p.order.closed': 'Closed orders p2p success',

	'success.p2p.balance.transfer_to_spot': 'Transfer to spot wallet success',
	'success.p2p.balance.transfer_to_funding': 'Transfer to spot funding success',
	...
	'error.p2p.payment.get_list_payments_configs.parse_json': 'Some thing wrong with configs',
	'error.p2p.payment.miss_kyc': 'error.p2p.payment.miss_kyc',
	'error.p2p.payment.get_list_payments.parse_json': 'Some thing wrong with configs',
	'error.p2p.payment.payments_configs.not_exit': 'Your payment method is not exist',
	'error.p2p.payment.payments_configs.invalid': 'Your payment method is invalid',
	'error.p2p.payment.payments_configs.invalid_field': 'Your payment have many file or lost field',
	'error.p2p.payment.edit.invalid': 'Your id payment is invalid',
	'error.p2p.payment.delete.invalid': 'Your payment is invalid',
	'error.p2p.payment.delete.have_in_some_order': 'Your payment use in some order',

	'error.p2p.orders.create': 'Your list id payment methods invalid',
	'error.p2p.orders.edit': 'Your list id payment methods invalid',
	'error.p2p.orders.cancel': 'Cancel order fail because your id order not found',
	'error.p2p.orders.miss_kyc': 'You must verify kyc',
	'error.p2p.orders.balance_not_enough': 'Your balance is not enough',
	'error.p2p.orders.min_max_order': 'Your min order amount is not in range',
	'error.p2p.orders.cancel.have_some_trade': 'Cancel order fail because your order have some trading',
	'error.p2p.orders.cancel.have_some_error_with_balance': 'Cancel order fail because your order have some error with balance',

	'error.p2p.balance.transfer.not_enough_money': 'Your balance is not enough',
	'error.p2p.balance.transfer.currency_id_invalid': 'Your Currency is invalid',
	...
	'page.body.plugins.wallet.withdraw.body.received': 'Awaiting Approval',
	'page.body.plugins.wallet.withdraw.body.reviewed':
		'Your withdrawal request is being reviewed and will take approximately 48 hours. You can view the status of your withdrawal request in the withdrawal history page.',
	...
	'page.body.plugins.wallet.withdraw.info.tip2':
		"2. When withdrawing to the Octium user's address, the handling fee will be returned to the Current Account by default. Learn more",
	...
	'landing.banner.content.header.title.desc': 'Octium creates infrastructure and provides support',
	...
	'landing.banner.content.header.title.end.desc': 'Octium provides many optionsto earn and monetize your platform',
	...
	'landing.banner.content.header.monetize.heading.4': 'Resell Octium Products and Services',
	'landing.banner.content.header.monetize.body4':
		'You can place a link to Octium and receive a commissions for every sale your link generates.',
	...
	'landing.banner.content.header.monetize.body6':
		'Octium packages include built-in Market Making (or liquidity generation) bots. Which means you are free to provide paid market making services to token and coin projects.',
	...
	'landing.banner.content.domain.udonex': 'octium.io - LIVE',
	'landing.banner.content.domain.udonswap': 'OCTIUM - SOON',
	...
	'landing.banner.content.demo.option.login.right.1': 'user@octium.io',
	'landing.banner.content.demo.option.password.right.1': 'demopassword',

	'landing.banner.content.demo.title.2': 'Admin',
	'landing.banner.content.demo.option.login.right.2': 'admin@octium.io',
