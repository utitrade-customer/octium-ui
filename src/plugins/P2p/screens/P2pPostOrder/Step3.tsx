...
import { OrderPostConfirmationModal } from 'plugins/P2p/components';
	...
	return (
		<>
			...
			<Form
				...
				form={form}
			>
				<div className="p2p-screen-post-order-step-wrapper p2p-screen-post-order__step-3">
					<div className="p2p-screen-post-order__step-3__remarks">
						<div className="p2p-screen-post-order__step-3__remarks__label">Remarks (Optional)</div>
						<div className="p2p-screen-post-order__step-3__remarks__textarea">
							<Form.Item name="remarks">
								<Input.TextArea rows={4} onChange={onChangeRemarks} />
							</Form.Item>
						</div>
					</div>
					<div className="p2p-screen-post-order__step-3__auto-reply">
						<div className="p2p-screen-post-order__step-3__auto-reply__label">Auto Reply (Optional)</div>
						<div className="p2p-screen-post-order__step-3__auto-reply__textarea">
							<Form.Item name="autoReply">
								<Input.TextArea rows={4} onChange={onChangeAutoReply} />
							</Form.Item>
						</div>
					</div>
					<div className="p2p-screen-post-order__step-3__conditions">
						<div className="p2p-screen-post-order__step-3__conditions__label">Counterparty Conditions</div>
						<div className="p2p-screen-post-order__step-3__conditions__complete-kyc">
							<AiOutlineCheckSquare />
							Completed KYC
						</div>
						<div className="p2p-screen-post-order__step-3__conditions__cb">
							<div className="p2p-screen-post-order__step-3__conditions__cb__inner">
								Registered <input type="text" value={registered} onChange={onChangeRegistered} /> day(s) ago
							</div>
						</div>
						<div className="p2p-screen-post-order__step-3__conditions__cb">
							<div className="p2p-screen-post-order__step-3__conditions__cb__inner">
								Holdings more than <input type="text" value={holdingBtc} onChange={onChangeHoldingBtc} /> BTC
							</div>
						</div>
						{/* <div className="p2p-screen-post-order__step-3__conditions__status">
							<div className="p2p-screen-post-order__step-3__conditions__status__label">Status</div>
							<Radio.Group>
