...
export const AddressInformation = (props: AddressInformationProps) => {
	const { inputChange, postalCode, city, residentialAddress } = props;
	const intl = useIntl();

	return (
		<div className="address-information">
			<div className="address-information__form">
					...
					<div className="col-md-12">
						<div className="form-group">
							...
							<input
								...
								onBlur={event => {
									inputChange('residential_address', upperFirstCase(event.target.value.trim()));
								}}
					...
					<div className="col-md-6">
						<div className="form-group">
							...
							<input
								...
								name="city"
								onBlur={event => {
									inputChange('city', upperFirstCase(event.target.value.trim()));
								}}
