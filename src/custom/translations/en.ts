export const en = {
	...
	'page.body.vote.news.title.you_can_buy': 'You can buy Octium on ',
	'page.body.vote.news.title.exchange_name': 'Octium',
	'page.body.vote.news.title.pancakeswap': 'Sunswap',
	...
	/* header */
	'header.markets.link.text': 'Markets',
	'header.launchpad.link.text': 'Launchpad',
	'header.smartStake.link.text': 'Smart Stake',
	'header.earnCoinFree.link.text': 'Earn Coin Free',
	'header.airdrop.link.text': 'Airdrop',
	'header.competition.link.text': 'Competition',
	'header.trade.link.text': 'Trade',
	'header.trade.dropdown.spot': 'Spot Trade',
	'header.trade.dropdown.p2p': 'P2P Trade',
};
