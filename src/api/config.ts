...
Cryptobase.config.api.p2pUrl = Cryptobase.config.api.p2pUrl || '/api/v2/p2p';
Cryptobase.config.api.pictureUrl = Cryptobase.config.api.pictureUrl || '/api/v2/picture';
...
export const pictureUrl = () => Cryptobase.config.api.pictureUrl;
